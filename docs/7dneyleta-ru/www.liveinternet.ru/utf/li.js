				...
				_widget: function(days, id) {
					...
					input.datepicker({
					    ...
					    onSelect: function(dateText) {
					        ...
					        window.location.href = 'showjournal.php@journalid='+id+'&jday='+explode[2]+'&jyear='+explode[0]+'&jmonth='+explode[1];
					    }
					});
                        ...
                        twttr.anywhere(function (T) {
                             /* -[ Create twit area ]- */
                              ...
                              /* -[ Previous posted twits ]- */
                                   ...
                                   comm.innerHTML = '<iframe src="ReActive/static/twitter/default.htm" frameborder="0" width="100%" height="auto" style="margin-top:10px;padding:10px;"></iframe>';
          ...
          LI.agelock.popup = function() {
               ...
               if (!shadow) {
                    ...
                    /* -[ Wrapper ]- */    
                         ...
                         wrapper.style.left = (LiCi.pageWidth() - 950) / 2 + 'px';
                         parent.appendChild( wrapper );                   
                         wrapper.innerHTML = '<div class="'+this.clName+'_wrapper_inner"><p>Автор не рекомендует просмотр этой страницы посетителям, моложе 18 лет.<span><a href="#" onclick="LI.agelock.accept();return false;">Мне есть 18 лет, открыть страницу</a><a href="top">На главную</a></span></p></div>';                                  
               }                   
          };         
     /* -----------[ Check ]----------- */    
	...
	/* -----------[ Print ]----------- */
		LI.printmedia.print = function() {
			if (LiCi.getCookie('ucss') == 'print') {
				document.write('<link rel="stylesheet" type="text/css" media="screen" href="ReActive/css/blog-print.css" />');
			}
	     ...
	     /* -----------[ Init ]----------- */
		  ...
		  /* -----------[ Insert ]----------- */
		     _insert: function() {
		     	// Check even or odd
			/* 	if (bbuserid%2 == 0) {
				 	LiCi.$(':gl_Top-plug').innerHTML = this._template('Glm', 'Читай, пиши, комментируй вместе с LiveInternet.<b>Дневники</b> Offline', 'click;libanner240');				 					 	
			 	} else {
				 	LiCi.$(':gl_Top-plug').innerHTML = this._template('4k', 'У Google Chrome появилось отличное расширение для удобного чтения дневников LiveInternet! <a target="_blank" href="click;libanner800@https_3A_2F_2Fchrome.google.com_2Fwebstore_2Fdetail_2Fliveinternet_25D0_25B4_25D0_25BD_25D0_25B5_25D0_25B0DC6C31E95">Хотите попробовать?</a><i class="gl_Top-plug_logo"></i>', 'click;libanner800');
			 	}
			 	// Position and events
