...
<body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-Mw_TMHGalleryHook_js rootpage-Mw_TMHGalleryHook_js skin-vector action-view">		<div id="mw-page-base" class="noprint"></div>
		<div id="mw-head-base" class="noprint"></div>
		<div id="content" class="mw-body" role="main">
			<a id="top"></a>
			<div id="siteNotice" class="mw-body-content"><!-- CentralNotice --></div><div class="mw-indicators mw-body-content">
</div>
<h1 id="firstHeading" class="firstHeading" lang="en">Mw.TMHGalleryHook.js</h1>			<div id="bodyContent" class="mw-body-content">
...
<li><span class="plainlinks"><a class="external text" href="//en.wikipedia.org/w/index.php?search=Mw.TMHGalleryHook.js&amp;title=Special%3ASearch&amp;fulltext=1">Search for "<i>Mw.TMHGalleryHook.js</i>"</a></span> in existing articles.</li>
...
<noscript><img src="//en.wikipedia.org/wiki/Special:CentralAutoLogin/start?type=1x1" alt="" title="" width="1" height="1" style="border: none; position: absolute;" /></noscript></div>					<div class="printfooter">
						Retrieved from "<a dir="ltr" href="https://en.wikipedia.org/wiki/Mw.TMHGalleryHook.js">https://en.wikipedia.org/wiki/Mw.TMHGalleryHook.js</a>"					</div>
		...
		<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgBackendResponseTime":184,"wgHostname":"mw1247"});});</script>
	</body>
</html>
