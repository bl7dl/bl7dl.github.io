...
----------------------------------------------- */
        ...
        /* -----------| Объявляем и получаем новые переменные |----------- */
                ...
                if (jurl!=null)
                {
                  var domain = (jurl.indexOf('liveinternet.ru')==-1)?jurl:"../www.liveinternet.ru/default.htm";
                }
                else
                {
                  var domain ="../www.liveinternet.ru/";
                }
                ...
                function jstpl_tpanel (tpl)
                {
                        /* - Повторяющиеся блоки - */
                                ...
                                /* - Форма авторизации - */
                                        ...
                                        {
                                          document.write('<form id="GlHdrNavMnuForm" style="display:none;" onKeyDown="checkKey(\'GlHdrNavMnuForm\');" action="../www.liveinternet.ru/member.php" method="post" name="aut">');
                                          ...
                                          document.write('<div id="GlHdrNavMnuAut">');
                                                ...
                                                /* - Вкладки - */
                                                  document.write('<ul id="GlHdrNavMnuTabs">');
                                                        ...
                                                        if (tpl=='beee')
                                                        {
															document.write('<li id="GlHdrNavMnuBeee">интернет<strong><span><em><a target="_blank" href="../www.liveinternet.ru/click;beeline_journal@lk.beeline.ru_2FrequestStepOne.do">инернет</a></em></span></strong></li>');                                                        	
                                                        }
                                                  document.write('</ul>');
                                          document.write('</div>');
                                ...
                                else
                                {
                                  document.write('<div id="GlHdrNavMnuNoaut">');
                                        /* - Просим авторизоваться - */
                                          tplanel_stand ('opn','GlHdrNavMnuLogin');
//                                                document.write('<a id="GlHdrNavMnuLoginLgn" href="javascript:void(0);" onClick="show_div(\'GlHdrNavMnuForm\',\'GlHdrNavMnuNoaut\');">Вход</a> / <a id="GlHdrNavMnuLoginReg" href="../www.liveinternet.ru/journal_register.php">Регистрация</a><span><a href="../www.liveinternet.ru/member.php@action=lostpw">Напоминание пароля</a> &nbsp;&nbsp;Найти своих: <a href=../www.liveinternet.ru/importmail.php@cmd=getbook&squery=>по переписке</a>, <a href=../www.liveinternet.ru/importmail.php@cmd=icq>из ICQ</a></span>');
                                                document.write('<a id="GlHdrNavMnuLoginLgn" href="journals.php@s=&action1=login">Вход</a> / <a id="GlHdrNavMnuLoginReg" href="../www.liveinternet.ru/journal_register.php">Регистрация</a><span><a href="../www.liveinternet.ru/member.php@action=lostpw">Напоминание пароля</a> &nbsp;&nbsp;Найти своих: <a href=../www.liveinternet.ru/importmail.php@cmd=getbook&squery=>по переписке</a>, <a href=../www.liveinternet.ru/importmail.php@cmd=icq>из ICQ</a></span>');
											//document.write('<ul><li id="GlHdrNavMnuBeee">интернет<strong><span><em><a target="_blank" href="../www.liveinternet.ru/click;beeline_journal@lk.beeline.ru_2FrequestStepOne.do">инернет</a></em></span></strong></li></ul>');
                                          tplanel_stand ('cls','');
                                  document.write('</div>');
