...
this.K=U(c)}else this.i=!!b,this.h=new V(null,this.i)};S.prototype.toString=function(){var a=[],b=this.A;b&&a.push(W(b,Bb,!0),":");var c=this.s;if(c||"file"==b)a.push("//"),(b=this.L)&&a.push(W(b,Bb,!0),"@"),a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),c=this.R,null!=c&&a.push(":",String(c));if(c=this.o)this.s&&"../../../default.htm"!=c.charAt(0)&&a.push("../../../default.htm"),a.push(W(c,"/"==c.charAt(0)?Cb:Db,!0));(c=this.h.toString())&&a.push("?",c);(c=this.K)&&a.push("#",W(c,Eb));return a.join("")};
S.prototype.resolve=function(a){var b=this.clone(),c=!!a.A;c?yb(b,a.A):c=!!a.L;if(c){var d=a.L;T(b);b.L=d}else c=!!a.s;c?(d=a.s,T(b),b.s=d):c=null!=a.R;d=a.o;if(c)zb(b,a.R);else if(c=!!a.o){if("../../../default.htm"!=d.charAt(0))if(this.s&&!this.o)d="../../../"+d;else{var e=b.o.lastIndexOf("/");-1!=e&&(d=b.o.substr(0,e+1)+d)}e=d;if(".."==e||"."==e)d="";else if(-1!=e.indexOf("default.htm")||-1!=e.indexOf("/.")){d=0==e.lastIndexOf("/",0);e=e.split("/");for(var f=[],g=0;g<e.length;){var k=e[g++];"."==k?d&&g==e.length&&f.push(""):".."==
...
var Ib=function(a){a=(a.H.cookie||"").split(";");for(var b=[],c=[],d,e,f=0;f<a.length;f++)e=na(a[f]),d=e.indexOf("="),-1==d?(b.push(""),c.push(e)):(b.push(e.substring(0,d)),c.push(e.substring(d+1)));return{keys:b,values:c}},Jb=new Hb;Jb.pb=3950;var Kb=function(){var a=(Jb.get("GuidedHelpResume")||"").split(":"),b=a[2];a:{for(c in ta)if(ta[c]==b){var c=!0;break a}c=!1}return{J:parseInt(a[0],10)||0,B:a[1]||"",source:(c?b:void 0)||"CUSTOM"}};var Lb={},Mb=va("https:../../../../https@ssl.gstatic.com/inproduct_help/guidedhelp/guide_inproduct.js"),lb=ya(Mb instanceof C&&Mb.constructor===C&&Mb.Da===ua?Mb.ga:"type_error:Const"),Ob=function(a,b){return Nb({S:b.S,document:b.document,I:b.I||"https://clients6.google.com",D:b.D,O:b.O,locale:b.locale}).then(function(){return q("help.guide.loadFlow")(a,b.B,b.Ua,b.Ia,b.source||"CUSTOM",b.document)})},Qb=function(a,b,c,d,e,f,g,k,n,A){a=A||window.top.location;if(!Pb(a).J)return!1;n=n||"";k=k||void 0;d=d||void 0;a=Pb(a||
...
b;c=a.serverUri||"../../../../https@www.google.com/tools/feedback";if(g=d.GOOGLE_FEEDBACK_START)g.apply(d,b);else{d=c+"/load.js?";for(var n in a)b=a[n],null!=b&&!v(b)&&(d+=encodeURIComponent(n)+"="+encodeURIComponent(b)+"&");a=(e?new F(9==e.nodeType?e:e.ownerDocument||e.document):ia||(ia=new F)).createElement("SCRIPT");f&&a.setAttribute("nonce",f);E(a,Ub(d));e.body.appendChild(a)}};p("userfeedback.api.startFeedback",Wb,void 0);var Xb=function(a,b){var c=a.serverUri||"../../../../https@www.gstatic.com/feedback";l.GOOGLE_HELP_SESSION_ARGUMENTS=arguments;var d=document.createElement("SCRIPT");c=Ub(c+"/session_load.js");E(d,c);window.document.body.appendChild(d)};p("userfeedback.api.help.resumeOpenHelpSession",Xb,void 0);p("userfeedback.api.help.startHelpWithChatSupport",function(a,b){a.flow="help";Wb(a,b)},void 0);var Yb=function(a,b){Xb(a,b);var c=a.serverUri||"../../../../https@www.google.com/tools/feedback";l.GOOGLE_HELP_CHAT_ARGUMENTS=arguments;var d=document.createElement("SCRIPT");c=Ub(c+"/chat_load.js");E(d,c);window.document.body.appendChild(d)};p("userfeedback.api.help.loadChatSupport",Yb,void 0);var Z=function(a,b){this.Qa=a;this.Ra=b.receiverUri;this.W=b.locale||b.locale||"en".replace(/-/g,"_");this.C=b.window||b.window||top;this.sa=b.zb||b.productData||{};this.oa=b.I||b.environment||"../../../../https@clients6.google.com";this.ba=b.ub||b.helpCenterPath||"";this.ka=b.D||b.apiKey||"";this.Ta=b.Ab||b.renderApiUri||""};p("help.service.Lazy",Z,void 0);
