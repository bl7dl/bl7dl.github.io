...
d.GOOGLE_FEEDBACK_START_ARGUMENTS=b;c=a.serverUri||"../../../https@www.google.com/tools/feedback";if(g=d.GOOGLE_FEEDBACK_START)g.apply(d,b);else{d=c+"/load.js?";for(var l in a)b=a[l],null!=b&&!Ba(b)&&(d+=encodeURIComponent(l)+"="+encodeURIComponent(b)+"&");a=bd(e).createElement("SCRIPT");f&&a.setAttribute("nonce",f);Zc(a,cg(d));e.body.appendChild(a)}});x("userfeedback.api.isBrowserSupportedForGenie",function(){return wi()});
