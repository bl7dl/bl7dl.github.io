...
function w(a,b){if(b){var c=k;a=a.split(".");for(var e=0;e<a.length-1;e++){var d=a[e];d in c||(c[d]={});c=c[d]}a=a[a.length-1];e=c[a];b=b(e);b!=e&&null!=b&&h(c,a,{configurable:!0,writable:!0,value:b})}}
w("Promise",function(a){function b(a){this.c=0;this.i=void 0;this.a=[];var b=this.f();try{a(b.resolve,b.reject)}catch(p){b.reject(p)}}
...
var d=k.setTimeout;c.prototype.f=function(a){d(a,0)};
c.prototype.k=function(){for(;this.a&&this.a.length;){var a=this.a;this.a=[];for(var b=0;b<a.length;++b){var c=a[b];a[b]=null;try{c()}catch(q){this.i(q)}}}this.a=null};
...
b.prototype.p=function(a){if(a===this)this.h(new TypeError("A Promise cannot resolve to itself"));else if(a instanceof b)this.q(a);else{a:switch(typeof a){case "object":var f=null!=a;break a;case "function":f=!0;break a;default:f=!1}f?this.o(a):this.k(a)}};
b.prototype.o=function(a){var b=void 0;try{b=a.then}catch(p){this.h(p);return}"function"==typeof b?this.r(b,a):this.k(a)};
...
b.prototype.n=function(){if(null!=this.a){for(var a=0;a<this.a.length;++a)g.c(this.a[a]);this.a=null}};
var g=new c;b.prototype.q=function(a){var b=this.f();a.j(b.resolve,b.reject)};
b.prototype.r=function(a,b){var c=this.f();try{a.call(b,c.resolve,c.reject)}catch(q){c.reject(q)}};
b.prototype.then=function(a,c){function f(a,b){return"function"==typeof a?function(b){try{d(a(b))}catch(K){e(K)}}:b}
var d,e,m=new b(function(a,b){d=a;e=b});
this.j(f(a,d),f(c,e));return m};
b.prototype.catch=function(a){return this.then(void 0,a)};
b.prototype.j=function(a,b){function c(){switch(f.c){case 1:a(f.i);break;case 2:b(f.i);break;default:throw Error("Unexpected state: "+f.c);}}
var f=this;null==this.a?g.c(c):this.a.push(c)};
b.resolve=e;b.reject=function(a){return new b(function(b,c){c(a)})};
b.race=function(a){return new b(function(b,c){for(var f=v(a),d=f.next();!d.done;d=f.next())e(d.value).j(b,c)})};
b.all=function(a){var c=v(a),d=c.next();return d.done?e([]):new b(function(a,b){function f(b){return function(c){p[b]=c;q--;0==q&&a(p)}}
var p=[],q=0;do p.push(void 0),q++,e(d.value).j(f(p.length-1),b),d=c.next();while(!d.done)})};
return b});
function x(a,b){return Object.prototype.hasOwnProperty.call(a,b)}
w("WeakMap",function(a){function b(a){this.a=(g+=Math.random()+1).toString();if(a){l();r();a=v(a);for(var b;!(b=a.next()).done;)b=b.value,this.set(b[0],b[1])}}
...
var d="$jscomp_hidden_"+Math.random();e("freeze");e("preventExtensions");e("seal");var g=0;b.prototype.set=function(a,b){c(a);if(!x(a,d))throw Error("WeakMap key fail: "+a);a[d][this.a]=b;return this};
...
return b});
w("Map",function(a){function b(){var a={};return a.d=a.next=a.l=a}
...
function e(a,b){var c=b&&typeof b;"object"==c||"function"==c?g.has(b)?c=g.get(b):(c=""+ ++m,g.set(b,c)):c="p_"+b;var d=a.c[c];if(d&&x(a.c,c))for(a=0;a<d.length;a++){var f=d[a];if(b!==b&&f.key!==f.key||b===f.key)return{id:c,e:d,index:a,b:f}}return{id:c,e:d,index:-1,b:void 0}}
function d(a){this.c={};this.a=b();this.size=0;if(a){a=v(a);for(var c;!(c=a.next()).done;)c=c.value,this.set(c[0],c[1])}}
...
l();r();var g=new WeakMap;d.prototype.set=function(a,b){var c=e(this,a);c.e||(c.e=this.c[c.id]=[]);c.b?c.b.value=b:(c.b={next:this.a,d:this.a.d,l:this.a,key:a,value:b},c.e.push(c.b),this.a.d.next=c.b,this.a.d=c.b,this.size++);return this};
...
if(function(){if(!a||"function"!=typeof a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var b=Object.seal({g:4}),e=new a(v([b]));if(!e.has(b)||1!=e.size||e.add(b)!=e||1!=e.size||e.add({g:4})!=e||2!=e.size)return!1;var d=e.entries(),g=d.next();if(g.done||g.value[0]!=b||g.value[1]!=b)return!1;g=d.next();return g.done||g.value[0]==b||4!=g.value[0].g||g.value[1]!=g.value[0]?!1:d.next().done}catch(m){return!1}}())return a;
...
return b});
var y=Date.now||function(){return+new Date};function z(a){return new Promise(function(b,c){var e=a.length,d=null;if(e)for(var g=function(a,g){a||d||(d=g);e--;e||(d?c(d):b())},m=v(a),f=m.next();!f.done;f=m.next())f.value.then(g.bind(null,!0),g.bind(null,!1));
else b()})}
...
function O(){return Promise.all([F("TimestampLowerBound"),P(),F("DeviceId")]).then(function(a){var b=v(a);a=b.next().value;var c=b.next().value;b=b.next().value;if(!a)return Promise.reject(null);a=N(c,b,a);return fetch("../../notifications_ajax@action_get_notifications=1",{credentials:"include",method:"POST",body:a}).then(Q)})}
...
function X(){C("RegistrationTimestamp",0);Promise.all([P(),Y(),aa()]).then(function(a){var b=v(a);a=b.next().value;var c=b.next().value;b=b.next().value;c&&(c=A(c));b&&(b=A(b));Z(a,c,b)}).catch(function(){Z()})}
function Z(a,b,c){a=void 0===a?null:a;b=void 0===b?null:b;c=void 0===c?null:c;E().then(function(e){e&&(C("Endpoint",a),C("P256dhKey",b),C("AuthKey",c),C("Permission",Notification.permission),Promise.all([F("DeviceId"),F("NotificationsDisabled")]).then(function(d){var e=v(d);d=e.next().value;e=e.next().value;d=N(a,d,null,null,e,b,c);fetch("../../notifications_ajax@action_register_device=1",{credentials:"include",method:"POST",body:d}).then(ba).catch(function(){})}))})}
function N(a,b,c,e,d,g,m){var f=new FormData;a&&f.append("endpoint",a);b&&f.append("device_id",b);c&&f.append("timestamp_lower_bound",c);e&&(f.append("notification_id",e.id),f.append("attribution_tag",e.attributionTag));d&&f.append("notifications_disabled",(!!d).toString());g&&f.append("p256dh_key",g);m&&f.append("auth_key",m);f.append("permission",Notification.permission);return f}
...
self.onnotificationclick=function(a){a.notification.close();var b=a.notification.data,c=self.clients.matchAll({type:"window",includeUncontrolled:!0});c.then(function(a){a:{var c=b.nav;a=v(a);for(var e=a.next();!e.done;e=a.next())if(e=e.value,e.url==c){e.focus();break a}self.clients.openWindow(c)}});
