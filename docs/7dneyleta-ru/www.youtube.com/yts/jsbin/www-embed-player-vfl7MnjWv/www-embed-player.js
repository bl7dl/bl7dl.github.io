...
z())&&0!=e;if(O||g||Ga)g=z(),h=g+1E3*h,l=g+1E3*l,1E-5>Math.random()&&ec("../../https@pagead2.googlesyndication.com/pagead/gen_204@id=imerr&err="+e),t[5]=e,t[1]=f,t[2]=h,t[3]=l,t[4]=m,t[6]=b,ee();if(O||!M.ca()){e=M.la();for(f=0;f<e.length;f++)M.ja(e[f]);e.length=0}}};
ge(a)}
...
;function fg(a){var b={"X-Goog-Visitor-Id":Q("VISITOR_DATA","")},c;a?c="Bearer "+v("gapi.auth.getToken")().nb:c=mc([]);c&&(b.Authorization=c,b["X-Goog-AuthUser"]=Q("SESSION_INDEX",0));return b}
...
;function hg(a,b,c,d){lc.set(""+a,b,c,"../default.htm",void 0===d?"youtube.com":d,!1)}
...
ig.prototype.get=function(a,b){var c=void 0,d=!this.b;if(!d)try{c=this.b.get(a)}catch(e){d=!0}if(d&&(c=lc.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
ig.prototype.remove=function(a){this.b&&this.b.remove(a);var b=this.f;lc.remove(""+a,"../default.htm",void 0===b?"youtube.com":b)};var jg=new ig;function kg(a,b,c,d){if(d)return null;d=jg.get("nextId",!0)||1;var e=jg.get("requests",!0)||{};e[d]={method:a,request:b,authState:gg(c),requestTime:Math.round(N())};jg.set("nextId",d+1,86400,!0);jg.set("requests",e,86400,!0);return d}
...
;function xg(a,b,c){yg({attachChild:{csn:a,parentVisualElement:rg(b),visualElements:[rg(c)]}})}
function yg(a){var b=eg;a.eventTimeMs=Math.round(N());a.lactMs=Rf();Zf({endpoint:"log_interaction",payload:a},b)}
;function zg(a){a=a||{};this.url=a.url||"";this.args=a.args||eb(Ag);this.assets=a.assets||{};this.attrs=a.attrs||eb(Bg);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
var Ag={enablejsapi:1},Bg={};zg.prototype.clone=function(){var a=new zg,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];a[b]="object"==ra(c)?eb(c):c}return a};function Cg(){G.call(this);this.b=[]}
n(Cg,G);Cg.prototype.m=function(){for(;this.b.length;){var a=this.b.pop();a.target.removeEventListener(a.name,a.pb)}G.prototype.m.call(this)};var Dg=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Eg(a){a=a||"";if(window.spf){var b=a.match(Dg);spf.style.load(a,b?b[1]:"",void 0)}else Fg(a)}
function Fg(a){var b=Gg(a),c=document.getElementById(b),d=c&&pe(c,"loaded");d||c&&!d||(c=Hg(a,b,function(){pe(c,"loaded")||(ne(c),ze(b),T(y(Ae,b),0))}))}
...
function Gg(a){var b=document.createElement("A");a=Cb(a);Gb(b,a);b=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Ua(b)}
;var Ig=v("ytLoggingLatencyUsageStats_")||{};u("ytLoggingLatencyUsageStats_",Ig,void 0);var Jg=0;function Kg(a){Ig[a]=Ig[a]||{count:0};var b=Ig[a];b.count++;b.time=N();Jg||(Jg=xf(Lg,0,5E3));return 10<b.count?(11==b.count&&sf(Error("CSI data exceeded logging limit with key: "+a),0==a.indexOf("info")?"WARNING":"ERROR"),!0):!1}
function Lg(){var a=N(),b;for(b in Ig)6E4<a-Ig[b].time&&delete Ig[b];Jg=0}
;function Mg(a,b){this.version=a;this.args=b}
;function Ng(a){this.topic=a}
Ng.prototype.toString=function(){return this.topic};var Og=v("ytPubsub2Pubsub2Instance")||new I;I.prototype.subscribe=I.prototype.subscribe;I.prototype.unsubscribeByKey=I.prototype.K;I.prototype.publish=I.prototype.I;I.prototype.clear=I.prototype.clear;u("ytPubsub2Pubsub2Instance",Og,void 0);u("ytPubsub2Pubsub2SubscribedKeys",v("ytPubsub2Pubsub2SubscribedKeys")||{},void 0);u("ytPubsub2Pubsub2TopicToKeys",v("ytPubsub2Pubsub2TopicToKeys")||{},void 0);u("ytPubsub2Pubsub2IsAsync",v("ytPubsub2Pubsub2IsAsync")||{},void 0);
u("ytPubsub2Pubsub2SkipSubKey",null,void 0);function Pg(a,b){var c=v("ytPubsub2Pubsub2Instance");c&&c.publish.call(c,a.toString(),a,b)}
;var X=window.performance||window.mozPerformance||window.msPerformance||window.webkitPerformance||{};function Qg(){var a=Q("TIMING_TICK_EXPIRATION");a||(a={},P("TIMING_TICK_EXPIRATION",a));return a}
function Rg(){var a=Qg(),b;for(b in a)zf(a[b]);P("TIMING_TICK_EXPIRATION",{})}
;function Sg(a,b){Mg.call(this,1,arguments)}
n(Sg,Mg);function Tg(a,b){Mg.call(this,1,arguments)}
n(Tg,Mg);var Ug=new Ng("aft-recorded"),Vg=new Ng("timing-sent");var Wg={vc:!0},Y={},Xg=(Y.ad_allowed="adTypesAllowed",Y.ad_at="adType",Y.ad_cpn="adClientPlaybackNonce",Y.ad_docid="adVideoId",Y.yt_ad_an="adNetworks",Y.p="httpProtocol",Y.t="transportProtocol",Y.cpn="clientPlaybackNonce",Y.csn="clientScreenNonce",Y.docid="videoId",Y.is_nav="isNavigation",Y.yt_lt="loadType",Y.yt_ad="isMonetized",Y.nr="webInfo.navigationReason",Y.ncnp="webInfo.nonPreloadedNodeCount",Y.paused="playerInfo.isPausedOnLoad",Y.fmt="playerInfo.itag",Y.yt_pl="watchInfo.isPlaylist",Y.yt_ad_pr=
"prerollAllowed",Y.yt_red="isRedSubscriber",Y.st="serverTimeMs",Y.vph="viewportHeight",Y.vpw="viewportWidth",Y.yt_vis="isVisible",Y),Yg="ap c cver ei srt yt_fss yt_li plid vpil vpni vpst yt_eil vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni pc pfa pfeh pftr prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts".split(" "),Zg="isNavigation isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber isVisible watchInfo.isPlaylist".split(" "),
bh=!1;function ch(){var a=dh().info.yt_lt="hot_bg";eh().info_yt_lt=a;if(fh())if("yt_lt"in Xg){var b=Xg.yt_lt;0<=Ba(Zg,b)&&(a=!!a);if(fh()){var c={};b=b.split(".");for(var d=c,e=0;e<b.length-1;e++)d[b[e]]=d[b[e]]||{},d=d[b[e]];d[b[b.length-1]]=a;a=gh();b=Object.keys(c).join("");Kg("info_"+b+"_"+a)||(c.clientActionNonce=a,dg("latencyActionInfo",c,void 0,void 0))}}else 0<=Ba(Yg,"yt_lt")||R(Error("Unknown label yt_lt logged with GEL CSI."))}
function hh(){var a=ih();if(a.aft)return a.aft;for(var b=Q("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
var jh=x(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||pa,X);function gh(){var a=dh().nonce;a||(a=og(),dh().nonce=a);return a}
function ih(){return dh().tick}
function eh(){var a=dh();"gel"in a||(a.gel={});return a.gel}
function dh(){return v("ytcsi.data_")||kh()}
function kh(){var a={tick:{},info:{}};u("ytcsi.data_",a,void 0);return a}
function lh(a,b){u("yt.timing."+(b||"")+"pingSent_",a,void 0)}
function mh(){var a=ih(),b=a.pbr,c=a.vc;a=a.pbs;return b&&c&&a&&b<c&&c<a&&1==dh().info.yt_pvis}
function fh(){return!!S("csi_on_gel")}
function nh(){Rg();if(!fh()){var a=ih(),b=dh().info,c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&w(a[f])){var d=f.slice(1);if(d in Wg){var e=Da(a[f],function(a){return Math.round(a-c)});
b["all_"+d]=e.join()}delete a[f]}var f=!!b.ap;if(d=v("ytglobal.timingReportbuilder_")){if(a=d(a,b,void 0))oh(a,f),kh(),jh(),lh(!1,void 0),Q("TIMING_ACTION")&&P("PREVIOUS_ACTION",Q("TIMING_ACTION")),P("TIMING_ACTION","")}else{var g=Q("CSI_SERVICE_NAME","youtube");d={v:2,s:g,action:Q("TIMING_ACTION",void 0)};e=ch.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var h=window.location.protocol+v("ytplayer.config.assets.js");(h=X.getEntriesByName?X.getEntriesByName(h)[0]:null)?b.h5jse=Math.round(b.h5jse-h.responseEnd):
delete b.h5jse}a.aft=hh();mh()&&"youtube"==g&&(ch(),g=a.vc,h=a.pbs,delete a.aft,b.aft=Math.round(h-g));for(var l in b)"_"!=l.charAt(0)&&(d[l]=b[l]);a.ps=N();b={};l=[];for(var m in a)"_"!=m.charAt(0)&&(g=Math.round(a[m]-c),b[m]=g,l.push(m+"."+g));d.rt=l.join(",");(a=v("ytdebug.logTiming"))&&a(d,b);oh(d,f,void 0);Pg(Vg,new Tg(b.aft+(e||0),void 0))}}}
function oh(a,b,c){if(S("debug_csi_data")){var d=v("yt.timing.csiData");d||(d=[],u("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}d="";for(var e in a)d+="&"+e+"="+a[e];a="/csi_204?";S("redirect_csi_204_to_qoe")&&(a="/api/stats/qoe?",d+="&redirect_csi_204_to_qoe=true");a+=d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var f=void 0===f?"":f;try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,f)||of(a,void 0,void 0,void 0,
f)}catch(g){of(a,void 0,void 0,void 0,f)}}else of(a);lh(!0,c)}
function ph(a){if("_"!=a[0]){var b=a;X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b))}b=ih();var c=N();b[a]&&(b["_"+a]=b["_"+a]||[b[a]],b["_"+a].push(c));b[a]=c;b=Qg();if(c=b[a])zf(c),b[a]=0;eh()["tick_"+a]=void 0;N();fh()?(b=gh(),"_start"==a?Kg("baseline_"+b)||dg("latencyActionBaselined",{clientActionNonce:b},void 0,void 0):Kg("tick_"+a+"_"+b)||dg("latencyActionTicked",{tickName:a,clientActionNonce:b},void 0,void 0),a=!0):a=!1;if(a=!a)a=!v("yt.timing.pingSent_");if(a&&(b=ke("TIMING_ACTION"),
a=ih(),v("ytglobal.timingready_")&&b&&a._start&&(b=hh()))){S("tighter_critical_section")&&!bh&&(Pg(Ug,new Sg(Math.round(b-a._start),void 0)),bh=!0);b=!0;c=Q("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&nh()}}
;function qh(a,b){G.call(this);this.l=this.S=a;this.G=b;this.o=!1;this.f={};this.P=this.F=null;this.w=new I;Gc(this,y(Hc,this.w));this.i={};this.N=this.R=this.h=this.X=this.b=null;this.M=!1;this.j=this.C=null;this.T={};this.sa=["onReady"];this.W=null;this.ia=NaN;this.O={};rh(this);this.U("WATCH_LATER_VIDEO_ADDED",this.Ja.bind(this));this.U("WATCH_LATER_VIDEO_REMOVED",this.Ka.bind(this));this.U("onAdAnnounce",this.va.bind(this));this.ta=new Cg(this);Gc(this,y(Hc,this.ta))}
n(qh,G);k=qh.prototype;
k.fa=function(a){if(!this.g){a instanceof zg||(a=new zg(a));this.X=a;this.b=a.clone();this.h=this.b.attrs.id||this.h;"video-player"==this.h&&(this.h=this.G,this.b.attrs.id=this.G);this.l.id==this.h&&(this.h+="-player",this.b.attrs.id=this.h);this.b.args.enablejsapi="1";this.b.args.playerapiid=this.G;this.R||(this.R=sh(this,this.b.args.jsapicallback||"onYouTubePlayerReady"));this.b.args.jsapicallback=null;if(a=this.b.attrs.width)this.l.style.width=bc(Number(a)||a);if(a=this.b.attrs.height)this.l.style.height=bc(Number(a)||
a);th(this);this.o&&uh(this)}};
...
function vh(a){var b=!0,c=wh(a);c&&a.b&&(a=a.b,b=pe(c,"version")==a.assets.js);return b&&!!v("yt.player.Application.create")}
function th(a){if(!a.g&&!a.M){var b=vh(a);if(b&&"html5"==(wh(a)?"html5":null))a.N="html5",a.o||xh(a);else if(yh(a),a.N="html5",b&&a.j)a.S.appendChild(a.j),xh(a);else{a.b.loaded=!0;var c=!1;a.C=function(){c=!0;var b=a.b.clone();v("yt.player.Application.create")(a.S,b);xh(a)};
a.M=!0;b?a.C():(Ee(a.b.assets.js,a.C),Eg(a.b.assets.css),zh(a)&&!c&&u("yt.player.Application.create",null,void 0))}}}
function wh(a){var b=Lb(a.h);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.h));return b}
function xh(a){if(!a.g){var b=wh(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.M=!1,b.isNotServable&&b.isNotServable(a.b.args.video_id)||Ah(a)):a.ia=T(function(){xh(a)},50)}}
function Ah(a){rh(a);a.o=!0;var b=wh(a);b.addEventListener&&(a.F=Bh(a,b,"addEventListener"));b.removeEventListener&&(a.P=Bh(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.f[e]||(a.f[e]=Bh(a,b,e))}for(var f in a.i)a.F(f,a.i[f]);uh(a);a.R&&a.R(a.f);a.w.I("onReady",a.f)}
function Bh(a,b,c){var d=b[c];return function(){try{return a.W=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.W=e,R(e,"WARNING",void 0,void 0,void 0))}}}
function rh(a){a.o=!1;if(a.P)for(var b in a.i)a.P(b,a.i[b]);for(var c in a.O)re(parseInt(c,10));a.O={};a.F=null;a.P=null;for(var d in a.f)a.f[d]=null;a.f.addEventListener=a.U.bind(a);a.f.removeEventListener=a.Ra.bind(a);a.f.destroy=a.dispose.bind(a);a.f.getLastError=a.za.bind(a);a.f.getPlayerType=a.Aa.bind(a);a.f.getCurrentVideoConfig=a.ya.bind(a);a.f.loadNewVideoConfig=a.fa.bind(a);a.f.isReady=a.Ia.bind(a)}
k.Ia=function(){return this.o};
k.U=function(a,b){var c=this,d=sh(this,b);if(d){if(!(0<=Ba(this.sa,a)||this.i[a])){var e=Ch(this,a);this.F&&this.F(a,e)}this.w.subscribe(a,d);"onReady"==a&&this.o&&T(function(){d(c.f)},0)}};
k.Ra=function(a,b){if(!this.g){var c=sh(this,b);c&&yd(this.w,a,c)}};
function sh(a,b){var c=b;if("string"==typeof b){if(a.T[b])return a.T[b];c=function(){var a=v(b);a&&a.apply(p,arguments)};
a.T[b]=c}return c?c:null}
function Ch(a,b){var c="ytPlayer"+b+a.G;a.i[b]=c;p[c]=function(c){var d=a.b&&a.b.args&&a.b.args.fflags;if(d&&0>d.indexOf("use_html5_player_event_timeout=true"))a.w.I(b,c);else{var f=T(function(){if(!a.g){a.w.I(b,c);var d=a.O,e=String(f);e in d&&delete d[e]}},0);
cb(a.O,String(f))}};
return c}
...
k.Aa=function(){return this.N||(wh(this)?"html5":null)};
k.za=function(){return this.W};
function yh(a){ph("dcp");a.cancel();rh(a);a.N=null;a.b&&(a.b.loaded=!1);var b=wh(a);b&&(vh(a)||!zh(a)?a.j=b:(b&&b.destroy&&b.destroy(),a.j=null));for(a=a.S;b=a.firstChild;)a.removeChild(b)}
k.cancel=function(){this.C&&Ke(this.b.assets.js,this.C);re(this.ia);this.M=!1};
k.m=function(){yh(this);if(this.j&&this.b&&this.j.destroy)try{this.j.destroy()}catch(b){R(b)}this.T=null;for(var a in this.i)p[this.i[a]]=null;this.X=this.b=this.f=null;delete this.S;delete this.l;G.prototype.m.call(this)};
function zh(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var Dh={},Eh="player_uid_"+(1E9*Math.random()>>>0);function Fh(a){var b="player";b=r(b)?Lb(b):b;var c=Eh+"_"+(b[wa]||(b[wa]=++xa)),d=Dh[c];if(d)return d.fa(a),d.f;d=new qh(b,c);Dh[c]=d;ze("player-added",d.f);Gc(d,y(Gh,d));T(function(){d.fa(a)},0);
return d.f}
function Gh(a){delete Dh[a.G]}
;function Hh(){var a=Ih(),b=Jh();if(!a&&!b||!window.JSON)return null;try{var c=a.get("yt-player-two-stage-token")}catch(d){}if(!r(c))try{c=b.get("yt-player-two-stage-token")}catch(d){}if(!r(c))return null;try{c=JSON.parse(c,void 0)}catch(d){}return c}
var Jh=Rb(function(){var a=new Jd;return a.isAvailable()?new Fd(a):null}),Ih=Rb(function(){var a=new Kd;
return a.isAvailable()?new Fd(a):null});function Kh(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
function Lh(a,b,c){r(a)&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});b=/\/([ve]|embed)\/([^#?]+)/.exec(a.mediaContentUrl);a.videoId=b&&b[2]?b[2]:null;return Mh(a)}
function Mh(a,b,c){if(va(a)){b="endSeconds startSeconds mediaContentUrl suggestedQuality videoId two_stage_token".split(" ");c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function Nh(a,b,c,d){if(va(a)&&!w(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};r(a)&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
function Oh(a){var b=a.video_id||a.videoId;if(r(b)){var c=Hh()||{},d=Hh()||{};q(void 0)?d[b]=void 0:delete d[b];var e=z()+3E5,f=Jh();if(f&&window.JSON){r(d)||(d=JSON.stringify(d,void 0));try{f.set("yt-player-two-stage-token",d,e)}catch(g){f.remove("yt-player-two-stage-token")}}(b=c[b])&&(a.two_stage_token=b)}}
;function Ph(a){G.call(this);this.b=a;this.b.subscribe("command",this.pa,this);this.f={};this.i=!1}
A(Ph,G);k=Ph.prototype;k.start=function(){this.i||this.g||(this.i=!0,Qh(this.b,"RECEIVING"))};
k.pa=function(a,b,c){if(this.i&&!this.g){var d=b||{};switch(a){case "addEventListener":r(d.event)&&(a=d.event,a in this.f||(c=x(this.Ta,this,a),this.f[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":r(d.event)&&Rh(this,d.event);break;default:this.h.isReady()&&this.h[a]&&(b=Sh(a,b||{}),c=this.h.handleExternalCall(a,b,c||null),(c=Th(a,c))&&this.i&&!this.g&&Qh(this.b,a,c))}}};
k.Ta=function(a,b){this.i&&!this.g&&Qh(this.b,a,this.aa(a,b))};
k.aa=function(a,b){if(null!=b)return{value:b}};
function Rh(a,b){b in a.f&&(a.removeEventListener(b,a.f[b]),delete a.f[b])}
k.m=function(){var a=this.b;a.g||yd(a.b,"command",this.pa,this);this.b=null;for(var b in this.f)Rh(this,b);Ph.u.m.call(this)};function Uh(a,b){Ph.call(this,b);this.h=a;this.start()}
A(Uh,Ph);Uh.prototype.addEventListener=function(a,b){this.h.addEventListener(a,b)};
Uh.prototype.removeEventListener=function(a,b){this.h.removeEventListener(a,b)};
function Sh(a,b){switch(a){case "loadVideoById":return b=Mh(b),Oh(b),[b];case "cueVideoById":return b=Mh(b),Oh(b),[b];case "loadVideoByPlayerVars":return Oh(b),[b];case "cueVideoByPlayerVars":return Oh(b),[b];case "loadPlaylist":return b=Nh(b),Oh(b),[b];case "cuePlaylist":return b=Nh(b),Oh(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];
case "setLoop":return[b.loopPlaylists];case "setShuffle":return[b.shufflePlaylist];case "getOptions":return[b.module];case "getOption":return[b.module,b.option];case "setOption":return[b.module,b.option,b.value];case "handleGlobalKeyDown":return[b.keyCode,b.shiftKey]}return[]}
function Th(a,b){switch(a){case "isMuted":return{muted:b};case "getVolume":return{volume:b};case "getPlaybackRate":return{playbackRate:b};case "getAvailablePlaybackRates":return{availablePlaybackRates:b};case "getVideoLoadedFraction":return{videoLoadedFraction:b};case "getPlayerState":return{playerState:b};case "getCurrentTime":return{currentTime:b};case "getPlaybackQuality":return{playbackQuality:b};case "getAvailableQualityLevels":return{availableQualityLevels:b};case "getDuration":return{duration:b};
case "getVideoUrl":return{videoUrl:b};case "getVideoEmbedCode":return{videoEmbedCode:b};case "getPlaylist":return{playlist:b};case "getPlaylistIndex":return{playlistIndex:b};case "getOptions":return{options:b};case "getOption":return{option:b}}}
Uh.prototype.aa=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return Uh.u.aa.call(this,a,b)};
Uh.prototype.m=function(){Uh.u.m.call(this);delete this.h};function Vh(a,b,c,d){G.call(this);this.f=b||null;this.o="*";this.h=c||null;this.sessionId=null;this.channel=d||null;this.C=!!a;this.l=x(this.w,this);window.addEventListener("message",this.l)}
n(Vh,G);Vh.prototype.w=function(a){if(!("*"!=this.h&&a.origin!=this.h||this.f&&a.source!=this.f)&&r(a.data)){try{var b=JSON.parse(a.data)}catch(c){return}if(!(null==b||this.C&&(this.sessionId&&this.sessionId!=b.id||this.channel&&this.channel!=b.channel))&&b)switch(b.event){case "listening":"null"!=a.origin&&(this.h=this.o=a.origin);this.f=a.source;this.sessionId=b.id;this.b&&(this.b(),this.b=null);break;case "command":this.i&&(!this.j||0<=Ba(this.j,b.func))&&this.i(b.func,b.args,a.origin)}}};
Vh.prototype.sendMessage=function(a,b){var c=b||this.f;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=Vc(a);c.postMessage(d,this.o)}catch(e){R(e,"WARNING")}}};
Vh.prototype.m=function(){window.removeEventListener("message",this.l);G.prototype.m.call(this)};function Wh(a,b,c){Vh.call(this,a,b,c||Q("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.j=this.b=this.i=null}
n(Wh,Vh);function Xh(){var a=this.f=new Wh(!!Q("WIDGET_ID_ENFORCE")),b=x(this.Na,this);a.i=b;a.j=null;this.f.channel="widget";if(a=Q("WIDGET_ID"))this.f.sessionId=a;this.h=[];this.j=!1;this.i={}}
k=Xh.prototype;k.Na=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.i[a]||"onReady"==a||(this.addEventListener(a,Yh(this,a)),this.i[a]=!0)):this.ra(a,b,c)};
k.ra=function(){};
function Yh(a,b){return x(function(a){this.sendMessage(b,a)},a)}
...
function Zh(a,b){a.sendMessage("infoDelivery",b)}
k.qa=function(a){this.j?this.f.sendMessage(a):this.h.push(a)};
k.sendMessage=function(a,b){this.qa({event:a,info:void 0==b?null:b})};
k.dispose=function(){this.f=null};function $h(a){Xh.call(this);this.b=a;this.g=[];this.addEventListener("onReady",x(this.La,this));this.addEventListener("onVideoProgress",x(this.Xa,this));this.addEventListener("onVolumeChange",x(this.Ya,this));this.addEventListener("onApiChange",x(this.Sa,this));this.addEventListener("onPlaybackQualityChange",x(this.Ua,this));this.addEventListener("onPlaybackRateChange",x(this.Va,this));this.addEventListener("onStateChange",x(this.Wa,this));this.addEventListener("onWebglSettingsChanged",x(this.Za,
this))}
A($h,Xh);k=$h.prototype;k.ra=function(a,b,c){if(this.b[a]){b=b||[];if(0<b.length&&Kh(a)){var d=b;if(va(d[0])&&!w(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Mh.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Lh.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=Nh.apply(window,d)}d=e}Oh(d);b.length=1;b[0]=d}this.b.handleExternalCall(a,b,c);Kh(a)&&Zh(this,this.ba())}};
...
mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());this.b.getStoryboardFormat&&(a.storyboardFormat=this.b.getStoryboardFormat());Zh(this,a)};
k.Ua=function(a){Zh(this,{playbackQuality:a})};
k.Va=function(a){Zh(this,{playbackRate:a})};
...
k.Ya=function(){Zh(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
k.Xa=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:z()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());Zh(this,a)};
k.Za=function(){if(this.b.getSphericalProperties){var a={sphericalProperties:this.b.getSphericalProperties()};Zh(this,a)}};
k.dispose=function(){$h.u.dispose.call(this);for(var a=0;a<this.g.length;a++){var b=this.g[a];this.b.removeEventListener(b.eventType,b.listener)}this.g=[]};function ai(){G.call(this);this.b=new I;Gc(this,y(Hc,this.b))}
A(ai,G);ai.prototype.subscribe=function(a,b,c){return this.g?0:this.b.subscribe(a,b,c)};
ai.prototype.j=function(a,b){this.g||this.b.I.apply(this.b,arguments)};function bi(a,b,c){ai.call(this);this.f=a;this.h=b;this.i=c}
A(bi,ai);function Qh(a,b,c){if(!a.g){var d=a.f;d.g||a.h!=d.b||(a={id:a.i,command:b},c&&(a.data=c),d.b.postMessage(Vc(a),d.h))}}
bi.prototype.m=function(){this.h=this.f=null;bi.u.m.call(this)};function ci(a,b,c){G.call(this);this.b=a;this.h=c;this.i=V(window,"message",x(this.j,this));this.f=new bi(this,a,b);Gc(this,y(Hc,this.f))}
...
ci.prototype.m=function(){Lf(this.i);this.b=null;ci.u.m.call(this)};function di(){var a=eb(ei),b;return od(new H(function(c,d){a.onSuccess=function(a){Xe(a)?c(a):d(new fi("Request failed, status="+a.status,"net.badstatus",a))};
a.onError=function(a){d(new fi("Unknown request error","net.unknown",a))};
a.L=function(a){d(new fi("Request timed out","net.timeout",a))};
...
n(fi,B);function gi(a){this.g=void 0===a?null:a;this.f=0;this.b=null}
gi.prototype.then=function(a,b,c){return this.g?this.g.then(a,b,c):1===this.f&&a?(a=a.call(c,this.b),bd(a)?a:hi(a)):2===this.f&&b?(a=b.call(c,this.b),bd(a)?a:ii(a)):this};
gi.prototype.getValue=function(){return this.b};
ad(gi);function ii(a){var b=new gi;a=void 0===a?null:a;b.f=2;b.b=void 0===a?null:a;return b}
function hi(a){var b=new gi;a=void 0===a?null:a;b.f=1;b.b=void 0===a?null:a;return b}
;function ji(a){B.call(this,a.message||a.description||a.name);this.isMissing=a instanceof ki;this.isTimeout=a instanceof fi&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof pd}
n(ji,B);ji.prototype.name="BiscottiError";function ki(){B.call(this,"Biscotti ID is missing from server")}
n(ki,B);ki.prototype.name="BiscottiMissingError";var ei={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},li=null;function mi(){if("1"===Za(le(),"args","privembed"))return gd(Error("Biscotti ID is not available in private embed mode"));li||(li=od(di().then(ni),function(a){return oi(2,a)}));
return li}
function ni(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new ki;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new ki;a=a.id;pi(a);li=hi(a);qi(18E5,2);return a}
function oi(a,b){var c=new ji(b);pi("");li=ii(c);0<a&&qi(12E4,a-1);throw c;}
function qi(a,b){T(function(){od(di().then(ni,function(a){return oi(b,a)}),pa)},a)}
function pi(a){u("yt.ads.biscotti.lastId_",a,void 0)}
function ri(){try{var a=v("yt.ads.biscotti.getId_");return a?a():mi()}catch(b){return gd(b)}}
;function si(a){B.apply(this,arguments)}
n(si,B);si.prototype.name="YuzuError";function ti(){var a=new si("ID is missing"),b=new si("Timeout"),c=null,d=!1;he(function(){c=fe();d=!0});
if(d)return c?hi(c):ii(a);var e=new H(function(b,c){he(function(){var d=fe();d?b(d):c(a)})}),f=Td().then(function(){return gd(b)});
return md(jd([e,f]),function(){return f.cancel()})}
;function ui(a){if("1"!==Za(le(),"args","privembed")){a&&(v("yt.ads.biscotti.getId_")||Aa("yt.ads.biscotti.getId_",mi));try{var b=ri();if(S("enable_yuzu")){v("yt.ads.yuzu.getId_")||u("yt.ads.yuzu.getId_",ti,void 0);try{var c=v("yt.ads.yuzu.getId_")()}catch(d){c=gd(d)}}else c=gd(new si("unimplemented"));kd([b,c]).then(function(a){var b=a[0];a=a[1];if(b.Y||a.Y){b=b.value;a=a.value;var c={};c.dt=fc;c.flash="0";a:{try{var d=window.top.location.href}catch(Ta){d=2;break a}d=null!=d?d==window.document.location.href?
...
F.navigator.mimeTypes.length);d.ca_type="image";if(S("enable_server_side_search_pyv")||S("enable_server_side_mweb_search_pyv")){l=window;try{var m=l.screenX;var t=l.screenY}catch(Ta){}try{var O=l.outerWidth;var Ga=l.outerHeight}catch(Ta){}try{var $g=l.innerWidth;var ah=l.innerHeight}catch(Ta){}m=[l.screenLeft,l.screenTop,m,t,l.screen?l.screen.availWidth:void 0,l.screen?l.screen.availTop:void 0,O,Ga,$g,ah];t=window.top;try{var U=(t||window).document,sa="CSS1Compat"==U.compatMode?U.documentElement:
...
for(var Sd in Ha)d[Sd]=Ha[Sd]}void 0!==b&&(d.bid=b);void 0!==a&&(d.anid=a);d.bsq=vi++;lf("../ad_data_204",{Ba:!1,A:d,withCredentials:!0})}});
T(ui,18E5)}catch(d){R(d)}}}
var vi=0;var Z=v("ytglobal.prefsUserPrefsPrefs_")||{};u("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function wi(){this.b=Q("ALT_PREF_COOKIE_NAME","PREF");var a=lc.get(""+this.b,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
k=wi.prototype;k.get=function(a,b){xi(a);yi(a);var c=void 0!==Z[a]?Z[a].toString():null;return null!=c?c:b?b:""};
k.set=function(a,b){xi(a);yi(a);if(null==b)throw Error("ExpectedNotNull");Z[a]=b.toString()};
k.remove=function(a){xi(a);yi(a);delete Z[a]};
...
function zi(a){a=void 0!==Z[a]?Z[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
qa(wi);var Ai=null,Bi=null,Ci=null,Di={};function Ei(a){dg(a.payload_name,a.payload,void 0,void 0)}
function Fi(a){var b=a.id;a=a.ve_type;var c=sg++;a=new qg({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});Di[b]=a;b=ug();c=tg();b&&c&&xg(b,c,a)}
function Gi(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(vg(b,a),a=tg()))for(var c in Di){var d=Di[c];d&&xg(b,a,d)}}
function Hi(a){Di[a.id]=new qg({trackingParams:a.tracking_params})}
function Ii(a){var b=ug();a=Di[a.id];b&&a&&(S("interaction_click_on_gel_web")?dg("visualElementGestured",{csn:b,ve:rg(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"}):yg({click:{csn:b,visualElement:rg(a)}}))}
function Ji(a){a=a.ids;var b=ug();if(b)for(var c=0;c<a.length;c++){var d=Di[a[c]];d&&dg("visualElementShown",{csn:b,ve:rg(d),eventType:1})}}
function Ki(){var a=Ai;a&&a.startInteractionLogging&&a.startInteractionLogging()}
...
u("writeEmbed",function(){var a=Q("PLAYER_CONFIG",void 0);ui(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=Q("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);Q("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&Oh(a.args);Ai=a=Fh(a);a.addEventListener("onScreenChanged",Gi);a.addEventListener("onLogClientVeCreated",Fi);a.addEventListener("onLogServerVeCreated",Hi);a.addEventListener("onLogToGel",Ei);
a.addEventListener("onLogVeClicked",Ii);a.addEventListener("onLogVesShown",Ji);a.addEventListener("onReady",Ki);b=Q("POST_MESSAGE_ID","player");Q("ENABLE_JS_API")?Ci=new $h(a):Q("ENABLE_POST_API")&&r(b)&&r(c)&&(Bi=new ci(window.parent,b,c),Ci=new Uh(a,Bi.f));c=ke("BG_P");Se(c)&&(Q("BG_I")||Q("BG_IU"))&&(Oe=!0,Ne.initialize(Q("BG_I",null),Q("BG_IU",null),c,Re));Cf()},void 0);
u("yt.www.watch.ads.restrictioncookie.spr",function(a){of(a+"mac_204@action_fcts=1");return!0},void 0);
var Li=me(function(){ph("ol");var a=wi.getInstance(),b=!!((zi("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&Kc(document.body,"exp-invert-logo"))if(c&&!Kc(document.body,"inverted-hdpi")){var d=document.body;d.classList?d.classList.add("inverted-hdpi"):Kc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":"inverted-hdpi")}else!c&&Kc(document.body,"inverted-hdpi")&&Lc();b!=c&&(b="f"+(Math.floor(119/31)+1),d=zi(b)||0,d=c?d|67108864:d&-67108865,
0==d?delete Z[b]:Z[b]=d.toString(16).toString(),a.save())}),Mi=me(function(){var a=Ai;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&Ne.dispose();a=0;for(var b=Af.length;a<b;a++)zf(Af[a]);Af.length=0;Je("../../static.doubleclick.net/instream/ad_status.js");Bf=!1;P("DCLKSTAT",0);Ic(Ci,Bi);if(a=Ai)a.removeEventListener("onScreenChanged",Gi),a.removeEventListener("onLogClientVeCreated",Fi),a.removeEventListener("onLogServerVeCreated",Hi),a.removeEventListener("onLogToGel",Ei),a.removeEventListener("onLogVeClicked",Ii),a.removeEventListener("onLogVesShown",Ji),a.removeEventListener("onReady",
Ki),a.destroy();Di={}});
window.addEventListener?(window.addEventListener("load",Li),window.addEventListener("unload",Mi)):window.attachEvent&&(window.attachEvent("onload",Li),window.attachEvent("onunload",Mi));Aa("yt.abuse.botguardInitialized",v("yt.abuse.botguardInitialized")||Te);Aa("yt.abuse.invokeBotguard",v("yt.abuse.invokeBotguard")||Ue);Aa("yt.abuse.dclkstatus.checkDclkStatus",v("yt.abuse.dclkstatus.checkDclkStatus")||Df);Aa("yt.player.exports.navigate",v("yt.player.exports.navigate")||wg);
