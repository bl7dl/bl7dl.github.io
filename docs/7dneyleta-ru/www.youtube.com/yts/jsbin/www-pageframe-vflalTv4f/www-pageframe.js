...
;var se=!C||Uc(9),te=C&&!Tc("9"),ue={valueOf:function(){if(!m.addEventListener||!Object.defineProperty)return!1;var a=!1,b=Object.defineProperty({},"passive",{get:function(){a=!0}});
m.addEventListener("test",t,b);m.removeEventListener("test",t,b);return a}}.valueOf();function ve(a,b){this.type=a;this.currentTarget=this.target=b;this.b=!1;this.Zc=!0}
...
z(xe,ve);var ye=function(a){return{valueOf:function(){return a}}.valueOf()}({2:"touch",
3:"pen",4:"mouse"});
...
function Hh(a,b){if(2==b||9==b){var c=null;a.U&&(c=null);var d=u(a.Xe,a);c||(c=new fh("../www.google.com/images/cleardot.gif"),Fg(c));Bh(c.toString(),1E4,d)}else J(2);mi(a,b)}
